...
import logoMain from './Img/Logo - Just Wolves.png' 

import logo1 from './Img/LoboGuara_d20_Logo-Hex.png' 
import logo2 from './Img/d20_logo-blue.png'
...
function App() {
  ...
  return (
    ...
    <header><h1> <img  className='App-logo' padding='5px' src={logo2} alt="d20" /> Dungeons & Dragons 5th Edition</h1> <h3 id='made-by'>  by Theo Bueno <a href={'https://theobueno.github.io/index.html'}><img width='35px' padding='2px' src={logoMain} alt="JustWolves Logo" /></a>    </h3></header>
        ...
        <div>
          ...
          <div>        
            <h1> <Button href={`https://www.dndbeyond.com/classes/${displayed.name}`} bg="light" variant="outline-danger" text="dark" 
              title='open class on D&D Beyond' className='beyond'> <img width={60} src={logo1} alt="Logo" /></Button>
